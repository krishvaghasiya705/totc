      ...
      <div className="container2">
        <div className="flex gap-30 justify-between">
          <div className="max-w-[681px] w-full mt-[111px]">
            ...
            <p className="text-2xl font-normal leading-[38px] text-white mb-[52px] max-w-[546px]">
            ...
            <div className="flex items-center gap-10">
              ...
              <div className="flex items-center gap-8">
                <div className="rounded-full bg-white h-20 w-20 flex justify-center items-center">
                  <Playicon />
                </div>
          ...
          <div className="max-w-[911px] w-full relative flex justify-center items-end">
            <Image
              src={Herobannergirl}
              alt="Herobannergirl"
              width={1000}
            ...
            />
            <div className="absolute top-2/4 left-0 -translate-y-2/4 w-full">
              <div className="flex justify-between gap-30 items-end">
                <div className="bg-whitelight2 rounded-[20px] px-7 py-[25px] flex items-center gap-8 max-w-[300px] h-min">
                  <Image
                    src={calendericon}
                    alt="calendericon"
                    width={1000}
              ...
              <div className="flex justify-between gap-30">
                <div className="bg-whitelight2 rounded-[20px] px-7 py-[25px] flex gap-6 max-w-[390px]">
                  <Image
