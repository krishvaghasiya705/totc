...
function SampleNextArrow(props) {
  ...
  return (
    <div
      className="absolute top-2/4 right-[131px] -translate-y-2/4"
      onClick={onClick}
    >
      ...
      <div className="container3">
        <div className="flex justify-between items-center">
          <div className="max-w-[607px]">
            ...
            <h1 className="text-6xl font-normal leading-[82px] mb-30 text-cusblue font-Nunito">
              What They Say?
            </h1>
            ...
            <Slider {...settings}>
              <div>
                <div className="relative pb-[120px]">
                  <div className="max-w-[560px] h-[700px]">
                    <Image
                      src={sliderimage}
                      alt="sliderimage"
                      width={1000}
